...
|---|---|---|---|---|---|---|
| **DeepWiki (Cognition)** | Yes — actively maintained; MCP server added 2025 ([blog](https://cognition.ai/blog/deepwiki-mcp-server)) | Free for public repos | SaaS (hosted) | Requires a paid Devin account ($20+/mo) ([Devin pricing](https://devin.ai/pricing/)) | Zero-effort wiki + MCP-accessible Q&A over your code | Your code leaves your infra; not source-controlled |
